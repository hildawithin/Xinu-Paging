...
/* in file bsm_lookup.c */

extern void bsm_lookup(pid32 , uint32 * , int* , int* );
...
extern void	pfhandler (int32	inum, long	*savedsp);
...
extern uint32 getfreeframe(void);
extern struct fnode* newNode(uint32);
extern struct fqueue* createQueue(void);
extern void enqueuef(struct fqueue*, uint32);
extern struct fnode* dequeuef(struct fqueue*);
...
extern void idpaging(uint32 *, unsigned int, int);
